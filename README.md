## Users list
#### Web-приложение на Java с использованием SpringBoot и БД PostgreSQL. <br /> front-end полностью написан на фреймфорке Vaadin.
#### При запуске приложения, пользователь с правами доступа USER не может получить доступ к общему списку, <br /> пользователь с правами ADMIN имеет доступ к списку всех пользователей, внесенных в БД, возможность удаления и добавления пользователей. <br /> Чтобы активировать кнопку удалить, необходимо выбрать пользователя через checkbox
